export { COMMAND_RENDER } from "react-state-driven";
...
export const events = {
  ...
  TIMER_ID_RECEIVED: "TIMER_ID_RECEIVED"
};
...
export const TIMER_RUNNING = "Timer running";
export const TIMER_REGISTERING = "Timer registering";
